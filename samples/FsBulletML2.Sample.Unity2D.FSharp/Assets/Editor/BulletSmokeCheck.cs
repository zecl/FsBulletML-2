    ...
    public static void Run()
    {
        ...
        try
        {
            ...
            failures += Fire(
                ...
                Runner.Load(EcsWorld.RandFunc, BulletMLManager.GetRank(), info.Bulletml),
                BulletKind.Enemy,
                null,
                2.4f, -0.5f);
            ...
            failures += Fire(
                "自機の 2way（左）",
                Runner.Load(EcsWorld.RandFunc, BulletMLManager.GetRank(), FsBulletML2.Bullets.Dsl.PlayerBullet.PlayerBullet.b2wayLeftBullet),
                BulletKind.Player,
            ...
            failures += Fire(
                "自機のホーミング",
                Runner.Load(EcsWorld.RandFunc, BulletMLManager.GetRank(), FsBulletML2.Bullets.Dsl.PlayerBullet.PlayerBullet.homing),
                BulletKind.Player,
                FsBulletML2.DTD.BulletType.Player,
                2.4f, -5.0f);
        }
