...
{
    /// <summary>
    /// 走らせられる弾幕の一覧。<b>同梱の 176 本 をそのまま引く。</b>
    ///
    /// <b>名前で引く表 を自分で書かない。</b> 書くと、弾幕が増えたときに
    ...
    public static class Catalog
    {
        ...
        /// 名前で引く。無ければ既定。
        ///
        /// <b>引き方が 3 通り 在る。</b> 一覧の名前は日本語の説明文
        /// （「Bulletsmorphで生成。紋章遺伝学その二。by 白い弾幕くん」）なので、
        /// 丸ごと打つのは現実的ではない。
        ///
        ///   丸ごと一致   一覧に出る名前そのもの
        ///   番号         "42"。一覧の順（ListAsync が返す順）
        ///   部分一致     最初に当たったもの
        ///
        /// <b>「無かった」を黙って既定にすり替える。</b> サンプルなので
        /// 繋がらないより出るほうを採るが、<b>返した名前 は <c>RoomInfo</c> に
        /// 載せる</b> —— 何を走らせているかは client 側 で読める。
        /// </summary>
        ...
        /// 既定 の弾幕。
        ///
        /// <b>一覧の頭 ではなく、名指し。</b> 頭 を採ると、弾幕が 1 本
        ...
        /// <summary>既定 の弾幕の名前。<b>丸ごと一致で引く</b>（一部 で引くと別のものに当たる）</summary>
