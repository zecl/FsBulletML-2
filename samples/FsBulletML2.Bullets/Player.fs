    ...
    Bulletml.Bulletml ({bulletmlXmlns = None; bulletmlType = Some ShootingDirection.BulletHorizontal; bulletmlName = Some "ホーミング弾"; bulletmlDescription = None},
      [BulletmlElm.Action ({actionLabel = Some (ActionLabel "top");},
        [Action.Repeat (Times (numExpr "2"), ActionElm.Action ({actionLabel = None;}, 
                         [Action.Fire ({fireLabel = None;}, Some (Direction (None,numExpr "(-30+$rand*120)")), None, BulletElm.BulletRef ({bulletRefLabel = BulletLabel "hmgLsr";}, [])); 
                          Action.Repeat (Times (numExpr "5"), ActionElm.Action ({actionLabel = None;},
                                                       [Action.Wait (numExpr "1");
                                                        Action.Fire ({fireLabel = None;}, Some (Direction (Some {directionType = DirectionType.Sequence;},numExpr "0")), None, BulletElm.BulletRef ({bulletRefLabel = BulletLabel "hmgLsr";}, []))]));
