...
module Original =
    ...
    let backfire =
        ...
        <| verticalXmlns "http://www.asahi-net.or.jp/~cs8k-cyu/bulletml" "オリジナル。後ろに弾を撃つ人々。 by 白い弾幕くん" {
            top {
                repeat "5+$rank*10" { fireRef "backFire" [] }
                wait "300"
            }
    ...
    let btb_1 =
        ...
        <| verticalXmlns "http://www.asahi-net.or.jp/~cs8k-cyu/bulletml" "大原さんのオリジナル、原点回帰その一 by 白い弾幕くん" {
            top {
                repeat "2" {
                    fire { refBullet "nway" [ "(8 + 28 * $rank * $rank)"; "0.4"; "0" ] }
                    wait "20"
                    ...
                    wait "20"
                    fire { refBullet "nway" [ "(8 + 28 * $rank * $rank)"; "0.4"; "(360 / (8 + 28 * $rank * $rank))" ] }
                    wait "20"
                ...
                repeat "10" {
                    ...
                    fire { refBullet "nwayaim" [ "(8 + 28 * $rank * $rank)"; "1.2 + 0.6 * $rank"; "0" ] }
                    wait "30"
                }
        ...
        <| verticalXmlns "http://www.asahi-net.or.jp/~cs8k-cyu/bulletml" "大原さんのオリジナル、原点回帰その二 by 白い弾幕くん" {
            top {
                repeat "280 / ((50 - 43 * $rank) * 4)" {
                    fire { refBullet "vaim" [ "0"; "0.7 + 0.9 * $rank" ] }
                    fire { refBullet "vaim" [ "18"; "0.7 + 0.9 * $rank" ] }
                    fire { refBullet "vaim" [ "-18"; "0.7 + 0.9 * $rank" ] }
                    wait "(50 - 43 * $rank)"
                    fire { refBullet "vabsolute" [ "0"; "0.7 + 0.9 * $rank" ] }
                    fire { refBullet "vabsolute" [ "60"; "0.7 + 0.9 * $rank" ] }
                    fire { refBullet "vabsolute" [ "120"; "0.7 + 0.9 * $rank" ] }
                    fire { refBullet "vabsolute" [ "180"; "0.7 + 0.9 * $rank" ] }
                    fire { refBullet "vabsolute" [ "240"; "0.7 + 0.9 * $rank" ] }
                    fire { refBullet "vabsolute" [ "300"; "0.7 + 0.9 * $rank" ] }
                    wait "(50 - 43 * $rank)"
                    fire { refBullet "vaimrev" [ "0"; "0.7 + 0.9 * $rank" ] }
                    fire { refBullet "vaimrev" [ "18"; "0.7 + 0.9 * $rank" ] }
                    fire { refBullet "vaimrev" [ "-18"; "0.7 + 0.9 * $rank" ] }
                    wait "(50 - 43 * $rank)"
                    fire { refBullet "vabsolute" [ "30"; "0.7 + 0.9 * $rank" ] }
                    fire { refBullet "vabsolute" [ "90"; "0.7 + 0.9 * $rank" ] }
                    fire { refBullet "vabsolute" [ "150"; "0.7 + 0.9 * $rank" ] }
                    fire { refBullet "vabsolute" [ "210"; "0.7 + 0.9 * $rank" ] }
                    fire { refBullet "vabsolute" [ "270"; "0.7 + 0.9 * $rank" ] }
                    fire { refBullet "vabsolute" [ "330"; "0.7 + 0.9 * $rank" ] }
                    wait "(50 - 43 * $rank)"
                }
    ...
    let btb_4 =
        ...
        <| verticalXmlns "http://www.asahi-net.or.jp/~cs8k-cyu/bulletml" "大原さんのオリジナル、原点回帰その四 by 白い弾幕くん" {
            top {
                fire { refBullet "dummy" [ "8 + 28 * $rank"; "0.6 + 0.9 * $rank" ] }
                wait "440 - 90 * $rank"
            }
            ...
            defBullet "dummy" {
                ...
                doActs (
                    body {
                        repeat "12" {
                            fire { refBullet "nwayabsolute" [ "$1"; "$2"; "0" ] }
                            wait "3"

                            repeat "2 + 3 * $rank" {
                                fire { refBullet "nwayabsolute" [ "$1 / 3"; "$2 * (0.9 + 0.4 * $rand)"; "(360 / 12)" ] }
                            }

                            wait "3"
                            fire { refBullet "nwayabsolute" [ "$1"; "$2"; "(360 / 36) * (1/4)" ] }
                            wait "3"
                            ...
                            repeat "2 + 3 * $rank" {
                                fire {
                                    refBullet
                                        "nwayabsolute"
                                        [ "$1 / 3"; "$2 * (0.9 + 0.4 * $rand)"; "(360 / 12) * (3/4)" ]
                                }
                            }

                            wait "3"
                            fire { refBullet "nwayabsolute" [ "$1"; "$2"; "(360 / 36) * (1/2)" ] }
                            wait "3"
                            ...
                            repeat "2 + 3 * $rank" {
                                fire {
                                    refBullet
                                        "nwayabsolute"
                                        [ "$1 / 3"; "$2 * (0.9 + 0.4 * $rand)"; "(360 / 12) * (1/2)" ]
                                }
                            }

                            wait "3"
                            fire { refBullet "nwayabsolute" [ "$1"; "$2"; "(360 / 36) * (3/4)" ] }
                            wait "3"
    ...
    let btb_6 =
        ...
        <| verticalXmlns "http://www.asahi-net.or.jp/~cs8k-cyu/bulletml" "大原さんのオリジナル、原点回帰その六 by 白い弾幕くん" {
            top {
                fire { refBullet "halfwinder" [ "1.8"; "2"; "360"; "-7" ] }
                fire { refBullet "halfwinder" [ "1.8"; "2"; "330"; "-6" ] }
                fire { refBullet "halfwinder" [ "1.8"; "2"; "300"; "-5" ] }
                fire { refBullet "halfwinder" [ "1.8"; "2"; "270"; "-4" ] }
                fire { refBullet "halfwinder" [ "1.8"; "2"; "240"; "-3" ] }
                fire { refBullet "halfwinder" [ "1.8"; "2"; "210"; "-2" ] }
                fire { refBullet "halfwinder" [ "1.8"; "2"; "180"; "-1" ] }
                fire { refBullet "halfwinder" [ "1.8"; "2"; "180"; "1" ] }
                fire { refBullet "halfwinder" [ "1.8"; "2"; "150"; "2" ] }
                fire { refBullet "halfwinder" [ "1.8"; "2"; "120"; "3" ] }
                fire { refBullet "halfwinder" [ "1.8"; "2"; "90"; "4" ] }
                fire { refBullet "halfwinder" [ "1.8"; "2"; "60"; "5" ] }
                fire { refBullet "halfwinder" [ "1.8"; "2"; "30"; "6" ] }
                fire { refBullet "halfwinder" [ "1.8"; "2"; "0"; "7" ] }
                wait "700"
            }
            ...
            defBullet "halfwinder" {
                ...
                doActs (
                    body {
                        fire { refBullet "bit" [ "$1"; "$2"; "$3"; "$4" ] }
                        fire { refBullet "changecolor" [ "$1"; "$2"; "$3"; "-$4" ] }
                        vanish
                    }
                )
            }
    ...
    let censored =
        ...
        <| verticalXmlns "http://www.asahi-net.or.jp/~cs8k-cyu/bulletml" "大原さんのオリジナル、検閲済 by 白い弾幕くん" {
            ...
            defBullet "arm" {
                doActs (
                    body {
                        ...
                        changeSpeed "0" "1"
                        wait "5"
                        fire { refBullet "halfwinder" [ "330"; "-8" ] }
                        fire { refBullet "halfwinder" [ "270"; "-5" ] }
                        fire { refBullet "halfwinder" [ "210"; "-2" ] }
                        fire { refBullet "halfwinder" [ "150"; "2" ] }
                        fire { refBullet "halfwinder" [ "90"; "5" ] }
                        fire { refBullet "halfwinder" [ "30"; "8" ] }
                        vanish
                    }
                )
            }
            ...
            defBullet "halfwinder" {
                ...
                doActs (
                    body {
                        fire { refBullet "bit" [ "$1"; "$2" ] }
                        fire { refBullet "changecolor" [ "$1"; "-$2" ] }
                        vanish
                    }
                )
            }
    ...
    let entangled_space =
        ...
        <| verticalXmlns "http://www.asahi-net.or.jp/~cs8k-cyu/bulletml" "大原さんのオリジナル、EntangledSpace by 白い弾幕くん" {
            top {
                fire { refBullet "dummy" [ "2.5"; "1.2 * (0.5 + 0.5 * $rank)"; "11 * (3.5 - 2.5 * $rank)"; "0"; "10" ] }
                fire { refBullet "dummy" [ "1.5"; "1.5 * (0.5 + 0.5 * $rank)"; "7 * (3.5 - 2.5 * $rank)"; "0"; "-8" ] }
                fire { refBullet "dummy" [ "0.5"; "1.8 * (0.5 + 0.5 * $rank)"; "5 * (3.5 - 2.5 * $rank)"; "0"; "6" ] }
                wait "1050 - 150 * $rank"
            }
    ...
    let fujin_ranbu_fake =
        ...
        <| verticalXmlns "http://www.asahi-net.or.jp/~cs8k-cyu/bulletml" "大原さんのオリジナル、偽婦人乱舞 by 白い弾幕くん" {
            top {
                fire { refBullet "dummy" [ "0.6 + 0.6 * $rank"; "48 - 41 * $rank"; "8 * $rank" ] }
                wait "400 - 100 * $rank"
            }
        ...
        <| untyped "オリジナル。はさみ。by 白い弾幕くん" {
            defAction "curve" {
                fire {
                    aim "$1"
                    speed "1.2+$rank*0.6"
                    ofBullet (bulletAnon { doActs (body { changeDirectionAim "$1*-1.5" "100" }) })
                }
            ...
            defBullet "bit" {
                ...
                doActs (
                    body {
                        ...
                        changeSpeed "0" "1"
                        wait "2"
                        fire { refBullet "groundbit" [] }
                        wait "30"
                        fire { refBullet "skybit" [] }
                        vanish
                    }
                )
            }
    ...
    let kujira =
        ...
        <| verticalXmlns "http://www.asahi-net.or.jp/~cs8k-cyu/bulletml" "大原さんのオリジナル、鯨幕砲 by 白い弾幕くん" {
            top {
                fire { refBullet "bit" [ "2"; "1.0" ] }
                fire { refBullet "bit" [ "-2"; "1.0" ] }
                wait "10"
                fire { refBullet "bit" [ "2.5"; "1.05" ] }
                fire { refBullet "bit" [ "-2.5"; "1.05" ] }
                wait "10"
                fire { refBullet "bit" [ "3"; "1.1" ] }
                fire { refBullet "bit" [ "-3"; "1.1" ] }
                wait "10"
                fire { refBullet "bit" [ "3.5"; "1.15" ] }
                fire { refBullet "bit" [ "-3.5"; "1.15" ] }
                wait "160"
    ...
    let time_twist =
        ...
        <| verticalXmlns "http://www.asahi-net.or.jp/~cs8k-cyu/bulletml" "大原さんのオリジナル、時空転換 by 白い弾幕くん" {
            ...
            defAction "future" { fire { refBullet "futureBit" [] } }
            ...
            defAction "medieval" { fire { refBullet "medievalBit" [] } }
            ...
            defAction "primal" { fire { refBullet "primalBit" [] } }
    ...
    let yokokasoku =
        ...
        <| untypedXmlns "http://www.asahi-net.or.jp/~cs8k-cyu/bulletml" "オリジナル。横加速。by 白い弾幕くん" {
            topFireAs "accelShot" {
                absolute "90"
                speed "0"
                ofBullet (bulletAnon { doActs (body { accel "80" { horizontal "3*$1" } }) })
            }
