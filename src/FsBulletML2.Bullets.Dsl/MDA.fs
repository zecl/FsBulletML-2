...
module MAD =
    ...
    let b2f =
        ...
        <| verticalXmlns "http://www.asahi-net.or.jp/~cs8k-cyu/bulletml" "紫月飴さんのオリジナル、地形トラップ風味 by 白い弾幕くん" {
            ...
            defBullet "curve" { doActs (body { changeDirectionRel "$1*85" "9-($rank*5)" }) }
    ...
    let b14b_2_3w =
        ...
        <| verticalXmlns "http://www.asahi-net.or.jp/~cs8k-cyu/bulletml" "紫月飴さんのオリジナル、棒状バラマキと変則3way by 白い弾幕くん" {
            ...
            topFireAs "fire2" {
                aim "($1+$2)*7"
                speedAbs "2.2+$rank*1"
                ofBullet (bullet "dummy" { doActs (body { () }) })
            }
        }
    ...
    let acc_n_dec =
        ...
        <| verticalXmlns "http://www.asahi-net.or.jp/~cs8k-cyu/bulletml" "紫月飴さんのオリジナル、加速弾と減速弾 by 白い弾幕くん" {
            ...
            defBullet "br" { doActs (body { changeSpeed "1.05" "25" }) }
        ...
        <| verticalXmlns "http://www.asahi-net.or.jp/~cs8k-cyu/bulletml" "紫月飴さんのオリジナル、もっさり。 by 白い弾幕くん" {
            ...
            defAction "seed" {
                fire {
                    absolute "180+$1"
                    speedAbs "$1/4-2"
                    ofBullet (bulletAnon { refActs "shoot" [ "-1*$2" ] })
                }

                fire {
                    absolute "180-$1"
                    speedAbs "$1/4-2"
                    ofBullet (bulletAnon { refActs "shoot" [ "$2" ] })
                }
            }
