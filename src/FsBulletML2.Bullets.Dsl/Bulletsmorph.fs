...
module Bulletsmorph =
    ...
    let aba_2 =
        ...
        <| verticalXmlns "http://www.asahi-net.or.jp/~cs8k-cyu/bulletml" "Bulletsmorphで生成。紋章遺伝学その二。by 白い弾幕くん" {
            ...
            defBullet "red" {
                speed "0.1"
                doActs (body { changeSpeed "4.0" "300" })
            }
        }
    ...
    let fallen_string =
        ...
        <| untyped "Bulletsmorphで生成。落下するひも。by 白い弾幕くん" {
            ...
            defBullet "bulletmls/[Progear]_round_4_boss_fast_rocket.xml:_:downAccel" {
                doActs (body { accel "120" { verticalAbs "2.7" } })
            }
            ...
            topFireAs "bulletmls/[Progear]_round_5_middle_boss_rockets.xml:_:udBlt" {
                ...
                ofBullet (bulletAnon { doActs (body { actionRef "impl:59" [] }) })
            }
        ...
        <| untyped "Bulletsmorphで生成。くねくねと誘導弾。 by 白い弾幕くん" {
            ...
            defAction "impl:259" {
                fire {
                    ...
                    ofBullet (bulletAnon { doActs (body { actionRef "impl:30" [] }) })
                }
            }
            ...
            defAction "impl:30" {
                ...
                repeat "10+$rank*10" { actionRef "impl:12" [] }
                vanish
            }
            ...
            defAction "impl:100" {
                repeat "4" {
                    fire {
                        ...
                        ofBullet (bulletAnon { doActs (body { actionRef "impl:205" [] }) })
                    }
