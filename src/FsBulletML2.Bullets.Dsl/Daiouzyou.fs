...
module Daiouzyou =
    ...
    let hibachi_4 =
        ...
        <| untyped "怒首領蜂大往生「緋蜂」発狂攻撃 by 白い弾幕くん" {
            ...
            defBullet "guruc" { doActs (body { changeDirectionRel "-270" "90" }) }
            defBullet "guruc2" { doActs (body { changeDirectionRel "-270" "170" }) }
            defBullet "guruc3" { doActs (body { changeDirectionRel "-270" "260" }) }
            defBullet "guruc4" { doActs (body { changeDirectionRel "-270" "300" }) }
            defBullet "guruc5" { doActs (body { changeDirectionRel "-270" "450" }) }
            defBullet "guruc6" { doActs (body { changeDirectionRel "-270" "600" }) }
            defBullet "guruc7" { doActs (body { changeDirectionRel "-270" "700" }) }
            defBullet "guruc8" { doActs (body { changeDirectionRel "-270" "800" }) }
            defBullet "guruc9" { doActs (body { changeDirectionRel "-270" "900" }) }
            defBullet "guruc10" { doActs (body { changeDirectionRel "0" "90" }) }
            defBullet "guruc11" { doActs (body { changeDirectionRel "270" "900" }) }
            defBullet "guruc12" { doActs (body { changeDirectionRel "270" "800" }) }
            defBullet "guruc13" { doActs (body { changeDirectionRel "270" "700" }) }
            defBullet "guruc14" { doActs (body { changeDirectionRel "270" "600" }) }
            defBullet "guruc15" { doActs (body { changeDirectionRel "270" "450" }) }
            defBullet "guruc16" { doActs (body { changeDirectionRel "270" "300" }) }
            defBullet "guruc17" { doActs (body { changeDirectionRel "270" "280" }) }
            defBullet "guruc18" { doActs (body { changeDirectionRel "270" "230" }) }
            defBullet "guruc19" { doActs (body { changeDirectionRel "270" "90" }) }
        }
    ...
    let hibachi_image =
        ...
        <| verticalXmlns "http://www.asahi-net.or.jp/~cs8k-cyu/bulletml" "怒首領蜂大往生「緋蜂」最終形態を妄想してみた by 白い弾幕くん" {
            ...
            defAction "top2" { actionRef "fan4" [ "4" ] }
            defAction "top3" { actionRef "fan4" [ "-4" ] }
        }
    ...
    let hibachi_maybe =
        ...
        <| verticalXmlns "http://www.asahi-net.or.jp/~cs8k-cyu/bulletml" "怒首領蜂大往生「緋蜂」最終形態に多分似たもの by 白い弾幕くん" {
            ...
            defAction "top1" { actionRef "spiral" [ "-2" ] }
        ...
        <| untypedXmlns "http://www.asahi-net.or.jp/~cs8k-cyu/bulletml" "怒首領蜂大往生一面ボス by 白い弾幕くん" {
            ...
            defBullet "seed3" {
                ...
                doActs (
                    body {
                        repeat "6" {
                            fire { ofBullet (bulletAnon { dir "-8" }) }
    ...
    let round_1_boss_hakkyou =
        ...
        <| verticalXmlns "http://www.asahi-net.or.jp/~cs8k-cyu/bulletml" "怒首領蜂大往生一面ボス、発狂。by 白い弾幕くん" {
            ...
            defBullet "rb" { refActs "red" [ "$1+$rand*20-10" ] }
    ...
    let round_3_boss_2 =
        ...
        <| verticalXmlns "http://www.asahi-net.or.jp/~cs8k-cyu/bulletml" "怒首領蜂大往生三面ボス「厳武」第三形態 by 白い弾幕くん" {
            ...
            defAction "top1" {
                ...
                fire {
                    speed "0"
                    ofBullet (bulletAnon { refActs "fanRoll" [ "7" ] })
                }
            ...
            defAction "top2" { actionRef "3wayRoll" [ "13" ] }
            defAction "top3" { actionRef "3wayRoll" [ "-13" ] }
    ...
    let round_6_boss_3 =
        ...
        <| verticalXmlns "http://www.asahi-net.or.jp/~cs8k-cyu/bulletml" "怒首領蜂大往生二周目一面ボス、その三 by 白い弾幕くん" {
            ...
            defAction "bm" {
                changeSpeed "0" "50"
                wait "45"
                fire { refBullet "round" [ "1.5"; "0" ] }
                fire { refBullet "round" [ "1.25"; "7" ] }
                fire { refBullet "round" [ "1"; "14" ] }
                vanish
            }
    ...
    let round_6_boss_4 =
        ...
        <| verticalXmlns "http://www.asahi-net.or.jp/~cs8k-cyu/bulletml" "怒首領蜂大往生二周目一面ボス、その四 by 白い弾幕くん" {
            top {
                fire { refBullet "round_seed" [] }
                fire { refBullet "sht" [ "0.8" ] }
                wait "20"
                fire { refBullet "round_seed" [] }
                wait "100"
                fire { refBullet "round_seed" [] }
                fire { refBullet "sht" [ "1" ] }
                wait "20"
                fire { refBullet "round_seed" [] }
                wait "100"
                fire { refBullet "round_seed" [] }
    ...
    let round_6_boss_5 =
        ...
        <| verticalXmlns "http://www.asahi-net.or.jp/~cs8k-cyu/bulletml" "怒首領蜂大往生二周目一面ボス、その五 by 白い弾幕くん" {
            ...
            defBullet "seed3" {
                speed "0.8"
                doActs (body { changeDirectionSeq "1.2" "9999" })
