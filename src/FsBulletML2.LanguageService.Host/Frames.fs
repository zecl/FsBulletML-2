...
let all: FrameSnippet list =
    [
...

        {
            ...
            Frame = el "changeSpeed" [] "" [ leaf "speed" "${1:1}"; leaf "term" "${2:30}" ]
        }

        {
            ...
            Frame =
                el
                    ...
                    []
                    ""
                    [ el "direction" [ "type", "absolute" ] "${1:180}" []; leaf "term" "${2:30}" ]
        }

        {
            ...
            Frame =
                el "bullet" [ "label", "${1:b1}" ] "" [ el "action" [] "" [ leaf "wait" "${2:30}"; leaf "vanish" "" ] ]
        }
